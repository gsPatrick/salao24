                            ...
                            <div className="flex items-center gap-2">
                                <div className="flex-grow">
                                    <div className="flex items-center border border-gray-300 rounded overflow-hidden">
                                        <button
                                            type="button"
                                            onClick={() => !isReadOnly && setFormData(prev => ({ ...prev, sessions: String(Math.max(1, (Number(prev.sessions) || 0) - 1)) }))}
                                            disabled={isReadOnly}
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => !isReadOnly && setFormData(prev => ({ ...prev, sessions: String((Number(prev.sessions) || 0) + 1) }))}
                                            disabled={isReadOnly}
                                            className="px-3 py-2 bg-gray-100 hover:bg-gray-200 text-gray-600 disabled:opacity-50"
                                        >
                                            +
                                    ...
                                    <p className="text-[10px] text-gray-400 mt-1 ml-1 uppercase font-bold tracking-wider">Quantidade de Vezes</p>
