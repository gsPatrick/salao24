...
const AppointmentCard: React.FC<{
    ...
    clientData,
        ...
        return (
            <div
                onClick={onClick}
                className={`w-full h-full z-10 p-3 rounded-lg shadow-md flex flex-col space-y-2 transition-all duration-200 overflow-hidden group ${isBirthday ? 'bg-yellow-300' : 'bg-white'
