                ...
                {segments.map(({ key, title, description }) => {
                    ...
                    return (
                        <button
                            ...
                            className={`w-full flex items-start gap-3 rounded-2xl border px-4 py-3 text-left transition-all duration-150 active:scale-[0.98] ${
                                isActive
        ...
        <div ref={accountSectionRef} className="space-y-6">
            ...
            <div className="flex justify-center">
                <button
                  ...
                  disabled={isLoading}
                  className="w-full sm:w-auto flex justify-center items-center py-3 px-6 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 transition-colors active:bg-gray-100"
              >
                  <GoogleIcon />
